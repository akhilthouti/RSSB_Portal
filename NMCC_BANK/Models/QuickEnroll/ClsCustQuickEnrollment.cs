...
namespace INDO_FIN_NET.Models.QuickEnroll
{
    public class ClsCustQuickEnrollment
    {
        ...
        [StringLength(20, ErrorMessage = "Should not exceed 50 characters")]
        [RegularExpression(@"^[a-zA-Z]+$", ErrorMessage = "Use letters only please")]
        public string FirstNameReKyc { get; set; }

        [Required(ErrorMessage = "Required", AllowEmptyStrings = false)]
        [Display(Name = "Middle Name ")]
        [StringLength(20, ErrorMessage = "Should not exceed 50 characters")]
        [RegularExpression(@"^[a-zA-Z]+$", ErrorMessage = "Use letters only please")]
        public string MiddleNameReKyc { get; set; }

        [Required(ErrorMessage = "Required", AllowEmptyStrings = false)]
        [Display(Name = "Last Name ")]
        [StringLength(20, ErrorMessage = "Should not exceed 50 characters")]
        [RegularExpression(@"^[a-zA-Z]+$", ErrorMessage = "Use letters only please")]
        public string LastNameReKyc { get; set; }

        [Display(Name = "Mobile No")]
        [StringLength(10, MinimumLength = 10, ErrorMessage = "Mobile Number must be 10 char long.")]
        [Range(5999999999, 9999999999999, ErrorMessage = "Mobile Number should Start with 6,7,8 or 9")]
        [RegularExpression("^[0-9]{0,10}$", ErrorMessage = "Only Numeric Numbers Can be Enter")]
        public string MobileReKyc { get; set; }

        [Display(Name = "Email Id")]
        [Required(ErrorMessage = "Enter Email ID", AllowEmptyStrings = false)]
        [EmailAddress(ErrorMessage = "invalid Email Address")]
        public string EmailIdReKyc { get; set; }

        [Display(Name = "Gender")]
        [Required(ErrorMessage = "Required", AllowEmptyStrings = false)]
        public string GenderReKyc { get; set; }
        public string ReKyc_PAN { get; set; }
        public string GenderForReKyc { get; set; }

        //[Required(ErrorMessage = "Required")]
        [Display(Name = "Date of Birth")]
        [Required(ErrorMessage = "Select DOB.", AllowEmptyStrings = false)]
        public string DateOfBirthReKyc { get; set; }

        [Display(Name = "Address Line 1")]
        public string ReKyc_AddressLine1 { get; set; }

        [Display(Name = "Address Line 2")]
        public string ReKyc_AddressLine2 { get; set; }

        [Display(Name = "Address Line 3")]
        public string ReKyc_AddressLine3 { get; set; }

        [Display(Name = "City/Town/Village")]
        public string ReKyc_City { get; set; }

        [Display(Name = "Pin Code")]
        public string ReKyc_PinCode { get; set; }

        [Display(Name = "State")]
        public string ReKyc_State { get; set; }

        [Display(Name = "Country Code Of Resindence")]
        public string ReKyc_CountryCode { get; set; }
        [Display(Name = "Occupation")]
        public string ReKyc_Occupation { get; set; }
        [Display(Name = "Annual Revenue")]
        public string ReKyc_AnnualRevenue { get; set; }
        public string ReKyc_PANR { get; set; }
        public string ReKyc_AADHA { get; set; }
        public string ReKyc_ELECD { get; set; }
        public string ReKyc_PASSP { get; set; }
        public string ReKyc_DRLIC { get; set; }
